...
public class WordBaseActionListener implements ActionListener{
	...
	public void actionPerformed(ActionEvent e){
		...
		switch(method){
	 	    case 0:FileFromDiskLoader fileFDL = new FileFromDiskLoader(filePath, settingsPath, wordBase, wordBase, 0);	   
	 	           String line = fileFDL.next();
	 	    	   word = fileFDL.word(line);
	 	    	   expla = fileFDL.meaning(line);
	 	           break;  //选择第一个单词开始，将第一个单词赋给word
	 	    
	 	    case 1:String input = JOptionPane.showInputDialog("输入单词：").toLowerCase();  //输入单词，在词库中查找，查找不到则进入case0	 	    
